...
namespace Re_Project.Users
{
    public partial class frmAddUpdateUser : Form
    {
        ...
        private void _LoadData()
        {
            ...
            ctlrPersonCardInfoWithFilter1.LoadPersonInfo(_User.PersonID);
        }
        ...
        private void btnNext_Click(object sender, EventArgs e)
        {
            ...
            {
                if (clsUser.isUserExistForPersonID(ctlrPersonCardInfoWithFilter1.PersonID) && _Mode == enMode.AddNew)
                {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            _User.PersonID = ctlrPersonCardInfoWithFilter1.PersonID;
